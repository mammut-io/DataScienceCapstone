...
Some facts:  
- Total of words in CMU Pronuciation Dictionary `r length(totalWordCMUProDic)`.  
- Total of words in CMU Pronuciation Dictionary that are different pronunciation
of the same word `r length(totalHomophoneCMUProDic)`.  
