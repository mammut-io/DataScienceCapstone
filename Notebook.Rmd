...
```{r nGramFreq10, echo=FALSE, cache=TRUE, message=FALSE}
...
`r (names(pairOrderHCcorporaEnUSblogs))[pairOrderHCcorporaEnUSblogs[1:15]]`  

Let's check some stats about the trigrams:

```{r nGramStatsEnUSblogs, echo=FALSE, cache=TRUE, message=FALSE}
...
`r (names(tripletOrderHCcorporaEnUSblogs))[tripletOrderHCcorporaEnUSblogs[1:15]]`  
