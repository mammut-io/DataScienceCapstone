...
```{r nGramFreq3, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq4, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq5, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq6, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq7, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq8, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq9, echo=FALSE, cache=TRUE, message=FALSE, include=FALSE}
...
```{r nGramFreq10, eval=FALSE, message=FALSE, cache=TRUE, include=FALSE}
...
Let's check some stats about the bigrams:
...
`r (names(gram2FreqHCcorporaEnUSblogs))[pairOrderHCcorporaEnUSblogs[1:15]]`  

Let's check some stats about the trigrams:
...
`r (names(gram3FreqHCcorporaEnUSblogs))[tripletOrderHCcorporaEnUSblogs[1:15]]`  
